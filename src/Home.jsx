...
//         <img src="https://upload.wikimedia.org/wikipedia/commons/4/48/Emoji_u1f34b.svg" alt="Lemon Logo" className="w-10 h-10 mr-3" />
...
//             className="w-2/3 bg-white shadow-xl rounded-2xl flex flex-col items-center justify-center p-6 hover:scale-105 transition-all border border-slate-200"
//           >
//             <span className="text-4xl mb-2">{allowedPanels[0].icon}</span>
//             <span className="font-semibold text-slate-700 text-center text-lg">
...
//             >
//               <span className="text-3xl mb-2">{p.icon}</span>
//               <span className="font-medium text-slate-700 text-center">{p.name}</span>
//             </Link>
//           ))}
//         </div>
//       )}
...
//                 to={panel.path}
//                 key={index}
//                 className="group rounded-xl bg-white p-6 shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-0.5"
//               >
//                 <div className={`w-12 h-12 rounded-lg ${panel.color} flex items-center justify-center mb-4 transition-transform group-hover:scale-110`}>
//                   {panel.icon}
//                 </div>
...
//               to={panel.path}
//               key={idx}
//               className="rounded-xl bg-white p-4 flex flex-col items-center shadow-xs transition-transform active:scale-95"
//             >
//               <div className={`w-12 h-12 rounded-lg ${panel.color} flex items-center justify-center mb-2`}>
//                 {panel.icon}
//               </div>
...
//       <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around items-center p-2">
...
//               >
//                 <div className={`w-14 h-14 rounded-xl mb-5 flex items-center justify-center bg-gradient-to-br ${panel.color} ${panel.iconColor} transition-transform group-hover:scale-110`}>
...
//               to={panel.path}
//               key={idx}
//               className="rounded-xl bg-white p-5 flex flex-col items-center shadow-xs transition-transform active:scale-95"
//             >
//               <div className={`w-12 h-12 rounded-lg mb-3 flex items-center justify-center bg-gradient-to-br ${panel.color} ${panel.iconColor}`}>
...
//       iconColor: "text-blue-600",
//       navIcon: <MdOutlineDashboard className="text-xl" />
//     },
//     { 
//       name: "Plant Master", 
//       path: "/plantmaster", 
...
//       iconColor: "text-teal-600",
//       navIcon: <RiUserSettingsLine className="text-xl" />
//     },
//     { 
//       name: "Truck Transaction", 
//       path: "/truck", 
...
//       iconColor: "text-orange-600",
//       navIcon: <RiTruckLine className="text-xl" />
//     },
//     { 
//       name: "Truck Locator", 
//       path: "/truckfind", 
...
//       iconColor: "text-green-600",
//       navIcon: <MdOutlineAnalytics className="text-xl" />
//     },
//     { 
//       name: "Schedule Board", 
//       path: "/truckshedule", 
...
//       iconColor: "text-pink-600",
//       navIcon: <BsCalendarCheck className="text-xl" />
//     },
//   ];
...
//               >
//                 <div className={`h-full rounded-2xl p-6 shadow-sm border border-gray-100 transition-all duration-300 hover:shadow-md hover:border-transparent ${panel.color}`}>
//                   <div className={`w-14 h-14 rounded-xl mb-5 flex items-center justify-center backdrop-blur-sm ${panel.iconColor} bg-white bg-opacity-50 shadow-inner`}>
//                     {panel.icon}
//                   </div>
...
//   // Mobile Dashboard
//   return (
//     <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 pb-24 font-sans">
//       {/* Main Content */}
//       <main className="p-5">
...
//           </div>
//           <div className="text-right">
//             <div className="text-lg font-medium text-gray-700">{formatTime(currentTime)}</div>
//           </div>
//         </div>
...
//             >
//               <div className={`rounded-xl p-5 shadow-sm border border-gray-100 transition-transform active:scale-[0.98] ${panel.color}`}>
//                 <div className={`w-12 h-12 rounded-lg mb-3 mx-auto flex items-center justify-center ${panel.iconColor} bg-white bg-opacity-50`}>
//                   {panel.icon}
//                 </div>
...
//       {/* Bottom Navigation */}
//       <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around items-center p-2 shadow-lg backdrop-blur-sm bg-opacity-90">
//         {allowedNavItems.map((item, index) => (
//           <Link 
//             to={item.path} 
//             key={index}
//             className="flex flex-col items-center p-2 rounded-xl text-gray-600 transition-colors hover:text-gray-900"
//           >
